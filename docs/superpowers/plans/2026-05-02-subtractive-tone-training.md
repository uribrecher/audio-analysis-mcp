...
2. **Schema availability:** `reverse-synth-research/parameter-mapping/subtractive.schema.json` exists and is on `main`. Verify:
   ```bash
   ls /Users/uribrecher/test/sounds-and-recreation/reverse-synth-research/parameter-mapping/subtractive.schema.json
   ls /Users/uribrecher/test/sounds-and-recreation/reverse-synth-research/parameter-mapping/synth-base.schema.json
   ```
